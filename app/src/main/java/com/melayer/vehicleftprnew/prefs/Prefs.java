package com.melayer.vehicleftprnew.prefs;
...
public class Prefs {
    ...
    public static final String PREFS_STORE_CODE = "STORE_CODE";
    ...
    public static String getKeyVehicleNo(Context context) {
        ...
        sharedPreferences = null;
        Log.e("Prefs", "getKeyVehicleNo: "+ vehicleName );
        return vehicleName;
    }
    ...
    public static void saveVehicleCode(Context context, String vehicleCode) {
        SharedPreferences pref = context.getSharedPreferences(PREFS_STORE_CODE, context.MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
        editor.putString(KEY_VEHICLE_CODE, vehicleCode.trim());
        editor.commit();
    }

    public static String getKeyVehicleCode(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(PREFS_STORE_CODE, Context.MODE_PRIVATE);
        String vehicleName = sharedPreferences.getString(KEY_VEHICLE_CODE, "none");
        sharedPreferences = null;
        Log.e("Prefs", "getKeyVehicleNo: "+ vehicleName );
        return vehicleName;
    }
